...
$essentialtweaks.Add_Click({
    ...
    Start-BitsTransfer -Source "https://raw.githubusercontent.com/technocapeman/windebloater/master/ooshutup10.cfg" -Destination ooshutup10.cfg
    Start-BitsTransfer -Source "https://dl5.oo-software.com/files/ooshutup10/OOSU10.exe" -Destination OOSU10.exe
    ./OOSU10.exe ooshutup10.cfg /quiet

    Write-Host "Limiting Telemetry..."
    ...
    # Keep this disabled if you want the ability to locate your device
...
$reinstallbloat.Add_Click({
    ...
    Write-Host "Finished reinstalling Bloatware"
})
